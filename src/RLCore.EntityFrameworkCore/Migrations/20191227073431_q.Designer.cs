...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RLCore.RL.RiverPatrolEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("RiverPatrolEventLevelId");

                    b.Property<int>("RiverPatrolEventSourceTypeId");

                    b.Property<int>("RiverPatrolEventTypeId");

                    b.Property<int>("RiverPatrolId");

                    b.Property<int>("UserId");

                    b.HasKey("Id");

                    b.HasIndex("RiverPatrolEventLevelId");

                    b.HasIndex("RiverPatrolEventSourceTypeId");

                    b.HasIndex("RiverPatrolEventTypeId");

                    b.HasIndex("RiverPatrolId");

                    b.HasIndex("UserId");

                    b.ToTable("RiverPatrolEvents");
                });

            modelBuilder.Entity("RLCore.RL.RiverPatrolEventLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("RiverPatrolEventLevels");
                });
            ...
            modelBuilder.Entity("RLCore.RL.RiverPatrolEvent", b =>
                {
                    b.HasOne("RLCore.RL.RiverPatrolEventLevel", "RiverPatrolEventLevel")
                        .WithMany()
                        .HasForeignKey("RiverPatrolEventLevelId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("RLCore.RL.RiverPatrolEventSourceType", "RiverPatrolEventSourceType")
                        .WithMany()
                        .HasForeignKey("RiverPatrolEventSourceTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("RLCore.RL.RiverPatrolEventType", "RiverPatrolEventType")
                        .WithMany()
                        .HasForeignKey("RiverPatrolEventTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("RLCore.RL.RiverPatrol", "RiverPatrol")
                        .WithMany()
                        .HasForeignKey("RiverPatrolId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("RLCore.RL.RiverPatrolEventLevel", b =>
                {
                    b.HasOne("RLCore.RL.RiverPatrolEventLevel", "Parent")
                        .WithMany("Subs")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
